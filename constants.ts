...
export const MODULES: Module[] = [
  // 第一循環 (1-6)
  {
    ...
    lifeQuestions: [
      '在你每星期生活，除了睡覺，飲食，個人護理清潔，家務（清潔和煮食），交通，工作糊口的時間使用外，例出你最用的最多時間？', 
      '當你做對了所有事結果卻不如預期時，你會懷疑自己嗎？'
    ],
    perspectives: {
      [PerspectiveType.ORDER]: { 
        book: '箴言', 
        theme: '敬畏是起點', 
        description: '「敬畏耶和華是知識的開端。」（箴 1:7）。智慧不是技巧，而是人生定位感。承認我不是世界的中心，也不是最終判斷者。智慧從「我不是神」開始。' 
      },
      [PerspectiveType.VANITY]: { 
        book: '傳道書', 
        theme: '智慧仍會失效', 
        description: '「多有智慧，就多有愁煩。」（傳 1:18）。誠實指出智慧不等於成功，正直不等於公平。當人看清制度與人生限制，反而更痛苦。智慧不能替人生「保證結果」。' 
      },
      [PerspectiveType.COLLAPSE]: { 
        book: '約伯記', 
        theme: '智慧不能避免苦難', 
        description: '「他在智慧上有能力。」（伯 12:13）。約伯敬畏神且有智慧，卻仍受苦。這反對一種簡化的信仰：做對的事就不會出事。真智慧是在苦難中不虛假。' 
      }
    },
    tensionGuide: `智慧的三個層次（整合模型）：
1. 定位型智慧（箴言）：關鍵詞為「敬畏、界線、方向」。我不是世界的中心，智慧是走在對的方向。
2. 破碎型智慧（傳道書）：關鍵詞為「虛空、挫敗、清醒」。世界不保證回報，智慧讓人看見限制。
3. 承受型智慧（約伯記）：關鍵詞為「苦難、沈默、真實」。智慧不能免疫痛苦，但能讓人不虛假。
核心轉向：從期待智慧給答案或解釋苦難，轉向智慧讓我站得住、容許沈默並陪人走過苦難。`,
    discussionPrompts: [
      '【箴言】閱讀箴言 1:7。情境：一個人很聰明但決定只問「對我有利嗎？」討論：他有智慧嗎？沒有敬畏的聰明會帶來什麼後果？',
      '【傳道書】閱讀傳道書 1:18。情境：一個正直人發現世界不公平。討論：為什麼看清現實反而更痛苦？如果智慧不能換來公平，你還想要它嗎？',
      '【約伯記】閱讀約伯記 1–2 章摘要。情境：一個無辜人突然失去一切。討論：你第一反應是找原因還是承認無解？面對苦難，你希望得到答案還是陪伴？',
      '【總結】如果智慧不保證成功、意義與安全，你認為它剩下什麼價值？'
    ],
    summary: '智慧不是掌控人生，而是在無法掌控時仍選擇誠實與敬畏。'
  },
  {
    id: 2,
    cycleId: 1,
    ...
    perspectives: {
      [PerspectiveType.ORDER]: { book: '箴言', theme: '善惡有別', description: '行為的後後果是社會秩序的基石，義人的路如晨光。' },
